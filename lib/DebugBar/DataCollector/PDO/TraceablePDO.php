...
namespace WHMCS\Module\Addon\NemcDebugBar\DebugBar\DataCollector\PDO;

use PDO;
use PDOException;
use WHMCS\Module\Addon\NemcDebugBar\DebugBar\DataCollector\PDO\TraceablePDOStatement;
...
class TraceablePDO extends PDO
{
    ...
    {
        $this->pdo = $pdo;
        $this->pdo->setAttribute(PDO::ATTR_STATEMENT_CLASS, array('WHMCS\Module\Addon\NemcDebugBar\DebugBar\DataCollector\PDO\TraceablePDOStatement', array($this)));
    }
